...
class DetalhesMidia(ctk.CTkToplevel):
    midia = None
    caminho_imagem_antiga = None
    caminho_imagem_nova = None


    def __init__(self, master, id_midia):
        ...
        self.midia = self.midia_service.listar_midia(id_midia)
        self.caminho_imagem_antiga = self.midia.caminho_imagem
        self.caminho_imagem_nova = self.midia.caminho_imagem
        ...
        musicshelf_label = ctk.CTkLabel(master=frame_musicshelf_label, text="Detalhes mídia", text_color=text_color, font=font_titulo)
        ...
        self.titulo_midia = ctk.CTkEntry(master=frame_titulo_midia, placeholder_text="Título da mídia", textvariable=ctk.StringVar(value=self.midia.titulo), font=font_texto, text_color=text_color, height=height_formulario, fg_color=background_color_formulario, corner_radius=corner_radius_formulario)
        ...
        self.artista_midia = ctk.CTkEntry(master=frame_artista_midia, placeholder_text="Artista/banda da mídia", textvariable=ctk.StringVar(value=self.midia.artista), font=font_texto, text_color=text_color, height=height_formulario, fg_color=background_color_formulario, corner_radius=corner_radius_formulario)
        ...
        self.genero_midia.set(self.midia.genero)
        ...
        self.tipo_midia.set(self.midia.tipo)
        ...
        self.formato_midia.set(self.midia.formato)
        ...
        self.ano_lancamento_midia = ctk.CTkEntry(master=frame_ano_lancamento_pais_midia, placeholder_text="Ano de lançamento da mídia", textvariable=ctk.StringVar(value=self.midia.ano_lancamento), font=font_texto, text_color=text_color, height=height_formulario, fg_color=background_color_formulario, corner_radius=corner_radius_formulario)
        ...
        self.pais_midia = ctk.CTkEntry(master=frame_ano_lancamento_pais_midia, placeholder_text="País de prensagem da mídia", textvariable=ctk.StringVar(value=self.midia.pais), font=font_texto, text_color=text_color, height=height_formulario, fg_color=background_color, corner_radius=corner_radius_formulario)
        ...
        self.forma_aquisicao_midia.set(self.midia.forma_aquisicao)
        ...
        self.valor_midia = ctk.CTkEntry(master=frame_forma_aquisicao_valor_data_entrada_midia, placeholder_text="Valor da mídia", textvariable=ctk.StringVar(value=self.midia.valor), font=font_texto, text_color=text_color, height=height_formulario, fg_color=background_color_formulario, corner_radius=corner_radius_formulario)
        ...
        self.data_entrada_midia = ctk.CTkEntry(master=frame_forma_aquisicao_valor_data_entrada_midia, placeholder_text="Data de entrada da mídia", textvariable=ctk.StringVar(value=self.midia.data_entrada.strftime("%d/%m/%Y")), font=font_texto, text_color=text_color, height=height_formulario, fg_color=background_color_formulario, corner_radius=corner_radius_formulario)
        ...
        self.conservacao_midia_midia.set(self.midia.conservacao_midia)
        ...
        self.conservacao_encarte_midia.set(self.midia.conservacao_encarte)
        ...
        self.conservacao_geral_midia.set(self.midia.conservacao_geral)
        ...
        self.descricao_midia = ctk.CTkEntry(master=frame_descricao_midia, placeholder_text="Descrição da mídia", textvariable=ctk.StringVar(value=self.midia.descricao), font=font_texto, text_color=text_color, height=60, fg_color=background_color_formulario, corner_radius=corner_radius_formulario)
        ...
        self.preview_imagem_midia = ctk.CTkLabel(master=frame_imagem_midia, image=self.arquivos_service.carregar_imagem(self.midia.caminho_imagem), text="", width=100, height=100)
        ...
        frame_botao_editar_deletar = ctk.CTkFrame(master=frame_campos_formulario, fg_color="transparent")
        frame_botao_editar_deletar.pack(side="top", fill="x")

        botao_editar = ctk.CTkButton(master=frame_botao_editar_deletar, text="Editar", command=self.editar_midia, fg_color="#505050", hover_color="#646464", font=font_texto, text_color=text_color, height=40, corner_radius=corner_radius_formulario)
        botao_editar.pack(side="left", fill="x", expand=True, padx=10)

        botao_deletar = ctk.CTkButton(master=frame_botao_editar_deletar, text="Deletar", command=self.deletar_midia, fg_color="#505050", hover_color="#646464", font=font_texto, text_color=text_color, height=40, corner_radius=corner_radius_formulario)
        botao_deletar.pack(side="left", fill="x", expand=True, padx=10)


    # Funções
    def editar_midia(self):
        ...
        try:
            midia = Midia().validar(
                ...
                caminho_imagem=self.caminho_imagem_nova,
            ...
            self.midia_service.editar_midia(midia, caminho_imagem_antiga=self.caminho_imagem_antiga, caminho_imagem_nova=self.caminho_imagem_nova, master=self.master)
    ...
    def deletar_midia(self):
        self.midia_service.deletar_midia(self.midia)
        self.destroy()

    def selecionar_imagem(self):
        self.caminho_imagem_nova = filedialog.askopenfilename(
            title="Selecione uma imagem",
            filetypes=[("Arquivos de Imagem", "*.png *.jpg *.jpeg *.webp"), ("Todos os arquivos", "*.*")]
        )

        if self.caminho_imagem_nova:
            self.preview_imagem_midia.configure(image=ctk.CTkImage(Image.open(self.caminho_imagem_nova), size=(100, 100)), text="")
